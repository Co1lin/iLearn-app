/**
 * Stolen from
 * <a href="https://android.googlesource.com/platform/frameworks/base/+/master/core/java/android/widget/ArrayAdapter.java">
 *     Source code of ArrayAdapter Class
 * </a>
 */
...
public class ACAdapter<T> extends BaseAdapter implements Filterable, ThemedSpinnerAdapter {
    ...
    /**
     * Contains the list of objects that represent the data of this ACAdapter.
    ...
    private AutoComplTextView mAcTextView;
     ...
     *                 instantiating views.
     */
    public ACAdapter(@NonNull Context context, @LayoutRes int resource) {
     ...
     */
    public ACAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull T[] objects) {
    ...
    private ACAdapter(@NonNull Context context, @LayoutRes int resource,
    ...
    public ACAdapter(@NonNull Context context, @LayoutRes int resource,
                      @IdRes int textViewResourceId, @NonNull int delButtonResourceId,
        ...
        mObjectsFromResources = objsFromResources;
        mFieldId = textViewResourceId;
        mDelButtonId = delButtonResourceId;
    }
    public ACAdapter(@NonNull Context context, @LayoutRes int resource,
                     @IdRes int textViewResourceId, @NonNull int delButtonResourceId,
                     List<T> objects) {
        this(context, resource, textViewResourceId, delButtonResourceId, objects, false);
    }

    public ACAdapter(@NonNull Context context, @LayoutRes int resource,
                     @IdRes int textViewResourceId, @NonNull int delButtonResourceId,
                     List<T> objects, AutoComplTextView acTextView) {
        this(context, resource, textViewResourceId, delButtonResourceId, objects, acTextView, false);
    }

    public ACAdapter(@NonNull Context context, @LayoutRes int resource,
                     @IdRes int textViewResourceId, @NonNull int delButtonResourceId,
                     List<T> objects, AutoComplTextView acTextView, boolean objsFromResources) {
        mContext = context;
        mInflater = LayoutInflater.from(context);
        mResource = mDropDownResource = resource;
        mObjects = objects;
    ...
    private @NonNull View createViewFromResource(@NonNull LayoutInflater inflater, int position,
        ...
        try {
            ...
            Log.e("ACAdapter", "You must supply a resource ID for a TextView");
            throw new IllegalStateException(
                    "ACAdapter requires the resource ID to be a TextView", e);
        }
        try {
            if (mDelButtonId != 0) {
            ...
            Log.e("ACAdapter", "You must supply a valid ID for a DelButton");
            throw new IllegalStateException(
                    "ACAdapter requires the delButtonResourceId to be a DelButton", e);
        }
    ...
    /**
     * Creates a new ACAdapter from external resources. The content of the array is
     ...
     *
     * @return An ACAdapter<CharSequence>.
     */
    public static @NonNull ACAdapter<CharSequence> createFromResource(@NonNull Context context,
                                                                         @ArrayRes int textArrayResId, @LayoutRes int textViewResId) {
        final CharSequence[] strings = context.getResources().getTextArray(textArrayResId);
        return new ACAdapter<>(context, textViewResId, 0, Arrays.asList(strings), true);
    }
    @Override
    public @NonNull
    Filter getFilter() {
